...
subtest "Legacy Route with URI Parameter" => sub {
    route_exists        [ GET => '/legacy/get/123' ], "GET /legacy/get/:var is handled";
    response_content_is [ GET => '/legacy/get/123' ], "Testing Get, Var Value is = 123",
      "got expected response content for /legacy/get/:var";

    route_exists        [ GET => '/good/get/123' ], "GET /good/get/:var is handled";
    response_content_is [ GET => '/good/get/123' ], "Testing Get, Var Value is = 123",
      "got expected response content for /good/get/:var";
};

subtest "Legacy Route with GET Args" => sub {
    my $legacy_response = dancer_response(GET => '/legacy/get/123/params', {
    ...
    my $standard_response = dancer_response(GET => '/good/get/123/params', {
        params => { var1 => 123, var2 => 456 }
    });
