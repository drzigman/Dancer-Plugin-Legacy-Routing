...
subtest "Ensure legacy_del directs to correct controller" => sub {
    route_exists        [ DELETE => '/legacy/delete' ], "DELETE /legacy/delete is handled";
...
subtest "Legacy Route with URI Parameter" => sub {
    route_exists        [ DELETE => '/legacy/delete/123' ], "DELETE /legacy/delete/:var is handled";
    response_content_is [ DELETE => '/legacy/delete/123' ], "Testing Delete, Var Value is = 123",
      "got expected response content for /legacy/delete/:var";

    route_exists        [ DELETE => '/good/delete/123' ], "DELETE /good/delete/:var is handled";
    response_content_is [ DELETE => '/good/delete/123' ], "Testing Delete, Var Value is = 123",
      "got expected response content for /good/delete/:var";
};

subtest "Legacy Route with DELETE Args" => sub {
    my $legacy_response = dancer_response(DELETE => '/legacy/delete/123/params', {
        params => { var1 => 123, var2 => 456 }
    });

    cmp_ok($legacy_response->{status}, '==', 200, "200 Response");
    cmp_ok($legacy_response->{content}, 'eq',
        "Testing Delete, Var1 Value is = 123 Var2 Value is = 456",
        "Properly Processed Parameters");

    my $standard_response = dancer_response(DELETE => '/good/delete/123/params', {
        params => { var1 => 123, var2 => 456 }
    });

    cmp_ok($standard_response->{status}, '==', 200, "200 Response");
    cmp_ok($standard_response->{content}, 'eq',
        "Testing Delete, Var1 Value is = 123 Var2 Value is = 456",
        "Properly Processed Parameters");
};
