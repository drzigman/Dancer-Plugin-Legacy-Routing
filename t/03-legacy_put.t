...
subtest "Legacy Route with URI Parameter" => sub {
    route_exists        [ PUT => '/legacy/put/123' ], "PUT /legacy/put/:var is handled";
    response_content_is [ PUT => '/legacy/put/123' ], "Testing Put, Var Value is = 123",
      "got expected response content for /legacy/put/:var";

    route_exists        [ PUT => '/good/put/123' ], "PUT /good/put/:var is handled";
    response_content_is [ PUT => '/good/put/123' ], "Testing Put, Var Value is = 123",
      "got expected response content for /good/put/:var";
};

subtest "Legacy Route with PUT Args" => sub {
    my $legacy_response = dancer_response(PUT => '/legacy/put/123/params', {
    ...
    my $standard_response = dancer_response(PUT => '/good/put/123/params', {
        params => { var1 => 123, var2 => 456 }
    });
