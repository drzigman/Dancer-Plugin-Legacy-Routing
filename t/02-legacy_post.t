...
subtest "Legacy Route with URI Parameter" => sub {
    route_exists        [ POST => '/legacy/post/123' ], "POST /legacy/post/:var is handled";
    response_content_is [ POST => '/legacy/post/123' ], "Testing Post, Var Value is = 123",
      "got expected response content for /legacy/post/:var";

    route_exists        [ POST => '/good/post/123' ], "POST /good/post/:var is handled";
    response_content_is [ POST => '/good/post/123' ], "Testing Post, Var Value is = 123",
      "got expected response content for /good/post/:var";
};

subtest "Legacy Route with POST Args" => sub {
    my $legacy_response = dancer_response(POST => '/legacy/post/123/params', {
    ...
    my $standard_response = dancer_response(POST => '/good/post/123/params', {
        params => { var1 => 123, var2 => 456 }
    });
